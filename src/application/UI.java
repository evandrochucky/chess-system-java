...
public class UI {
	...
	// ctrl + shift + f => alinha o código automáticamente
	...
	public static void printPiece(ChessPiece piece, boolean backGround) {
		...
		if (piece == null) {
			...
			// Definir a cor da peça a ser apresentada no terminal
	...
	//Logica de impressão na tela a lista de peças capturadas
	private static void printCapturedPieces(List<ChessPiece> captured) {
		//operação basica para filtrar minha lista
